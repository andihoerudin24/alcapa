	...
	<div class="col-12 pb-4 px-4 mt-4 animate-up">
		...
		<div class="card">
			<div class="card-body mt-0 pt-3">
						...
						<div class="row">
							<div class="col-12 col-sm-3">
								<div class="form-group">
									<h6 class="fontsize-smallest my-2">Filter Customer Name</h6>
									<input type="text" class="form-control shape table-like input-filter-text fontsize-smaller" name="customer_name">
								</div>
							</div>
							<div class="col-12 col-sm-3">
								<div class="form-group">
									<h6 class="fontsize-smallest my-2">Filter Customer Email</h6>
									<input type="text" class="form-control shape table-like input-filter-text fontsize-smaller" name="customer_email">
								</div>
							</div>
							<div class="col-12 col-sm-3">
								<div class="form-group">
									<h6 class="fontsize-smallest my-2">Filter Customer Phone</h6>
									<input type="text" class="form-control shape table-like input-filter-text fontsize-smaller" name="customer_phone">
								</div>
							</div>
							<div class="col-12 col-sm-3">
								<div class="float-right mt-1">
									<a href="<?php echo site_url(); ?>customer/export" target="_blank">
				...
				<table class="table display nowrap table-hover fontsize-smallest" id="table-data" data-order="[0,1,2]" data-text-center="[0]" data-text-right="[]" data-link="customer/data">
					<thead>
						<tr>
							...
							<td><strong>Customer Join Date</strong></td>
						</tr>
					</thead>
					<tbody></tbody>
				</table>
