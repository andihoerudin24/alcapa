					...
					<div class="card-body">
						...
						<form  action="<?php echo site_url();?>product/update/" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="text" name="product_title" class="form-control" value="<?php echo $product['product_title'] ?>" placeholder="Name Product">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" value="<?php echo $product['product_subcategory'] ?>" name="product_subcategory" class="form-control" placeholder="Product">
							</div>

							<div class="form-group">
								<label for="exampleInputEmail1">Product Sub Child</label>
								<input type="text" value="<?php echo $product['product_subchild'] ?>" name="product_subchild" class="form-control" placeholder="Product">
							</div>

							<div class="form-group">
								<label for="exampleInputEmail1">weight</label>
								<input type="number" value="<?php echo $product['product_weight'] ?>" name="product_weight" class="form-control" placeholder="weight">
							</div>
