                        ...
                        <form action="<?php echo site_url();?>product/update/" method="post"
                            ...
                            <div class="row justify-content-between">
                                <div class="col-md-5">
                                    <div class="form-group ">
                                        ...
                                        <input name="SKU" class="form-control" disabled
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input name="product_title" class="form-control"
                                            value="<?php echo $product['product_title'] ?>" placeholder="Product title">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="product_subcategory" class="form-control"
                                            placeholder="Product" value="<?php echo $product['product_subcategory'] ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="product_subchild" class="form-control"
                                            value="<?php echo $product['product_subchild'] ?>" placeholder="Product">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="product_stock" class="form-control"
                                            value="<?php echo $product['product_stock'] ?>" placeholder="Price">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="validationCustom01">Weight (gram)</label>
                                        <input type="number" class="form-control" placeholder="kg" required
                                            value="<?php echo $product['product_weight'] ?>" name="product_weight">
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- <div class="form-group">
                                ...
                                <input type="text" name="product_title" class="form-control"
                                    value="<?php echo $product['product_title'] ?>" placeholder="Name Product">
                            </div> -->
                            ...
                            <!-- <div class="form-group">
                                <label for="exampleInputEmail1">Product Sub Category</label>
                                <input type="text" value="<?php echo $product['product_subcategory'] ?>"
                                    name="product_subcategory" class="form-control" placeholder="Product">
                            </div> -->

                            <!-- <div class="form-group">
                                <label for="exampleInputEmail1">Product Sub Child</label>
                                <input type="text" value="<?php echo $product['product_subchild'] ?>"
                                    name="product_subchild" class="form-control" placeholder="Product">
                            </div> -->

                            <!-- <div class="form-group">
                                <label for="exampleInputEmail1">weight</label>
                                <input type="number" value="<?php echo $product['product_weight'] ?>"
                                    name="product_weight" class="form-control" placeholder="weight">
                            </div> -->
