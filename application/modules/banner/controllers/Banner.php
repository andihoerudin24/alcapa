...
class Banner extends MX_Controller
{
    ...
    {
        $data['datas'] = $this->model_data->list_banner();
        ...
        $this->load->view('banner/banner-page', $data);
    ...
    {   
        ...
        if (isset($_POST['submit'])) {
            $banners = $this->upload_image();
            $id= $this->input->post('id');
            if ($banners) {
                $data = array(
                    'image' => base_url() . 'uploads/banner/' .$banners,
                );
                $this->db->where('id',$id);
            ...
            $data['product'] = $this->db->get_where('banner', array('id' => $uri))->row_Array();
            $data['status'] = 'sales marketing';
            ...
            $this->load->view('frame/menu', $data);
            $this->load->view('frame/breadcrumb');
            $this->load->view('banner/banner-edit', $data);
            $this->load->view('frame/footer');
        }
    ...
    public function add()
    {
        if (isset($_POST['submit'])) {
            ...
            $this->load->view('frame/menu', $data);
            $this->load->view('frame/breadcrumb');
            $this->load->view('banner/banner-add', $data);
            $this->load->view('frame/footer');
        }
    }
